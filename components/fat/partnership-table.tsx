    ...
    sections: [
      {
        ...
        items: [
          ...
          "One branded collaborative post on Instagram",
        ],
      },
      {
        heading: "ONSITE PRESENCE",
      ...
      {
        heading: "ONSITE ACTIVATION (CHOOSE 1)",
        items: ["Opportunity to activate promotional space at the sponsored venue."],
      },
      {
        heading: "EVENT BENEFITS",
        items: ["4 VIP Passes", "6 GENERAL ADMISSION TICKETS"],
    ...
    sections: [
      {
        heading: "OVERVIEW",
        items: [
          "By providing in-kind product support, your brand will play a crucial role in creating unforgettable looks on our models, performers, and special guests - while being showcased to an engaged, style-conscious audience.",
        ],
      },
      {
        heading: "WHAT YOU'LL GET (BENEFITS)",
        items: [
          "Brand Visibility: Your products featured backstage and on set.",
          "Social Media: Mentions with the format and quantity to be negotiated with the Social Media Manager.",
          "Logo Placement: Featured on our website, event screens and social media.",
          "Direct Access: Products used and tested by professional HMUAS.",
          "Engagement: Opportunities for product demonstrations.",
          "Customization: Packages can be amended and customized during negotiations based on the contribution.",
        ],
      },
      {
        heading: "WHAT WE'RE LOOKING FOR",
        items: [
          "AV Equipment, Food & Catering, Infrastructure, Furniture & Decor, Professional Services",
          "Hair styling tools and products",
          "Skincare essentials and prep products",
          "Makeup (foundations, pigments, lip products, etc.)",
