...
import { AnimatedImpactMetrics } from "@/components/fat/animated-impact-metrics"
import { AudienceDemographicsChart } from "@/components/fat/audience-demographics-chart"
import { PressLogoMarquee } from "@/components/fat/press-logo-marquee"
...
export function AudienceImpactSection() {
  return (
    <SectionWrapper id="audience-impact" className="py-24 md:py-32">
      <div className="flex flex-col gap-12">
        <span className="reveal text-primary font-sans text-xs tracking-[0.25em] uppercase">
          Audience & Impact 2025
        </span>

        <SectionHeading as="h2">
          Showcasing Creativity, Engaging Millions
        </SectionHeading>

        <p className="reveal font-sans text-muted-foreground text-base md:text-lg leading-relaxed max-w-3xl">
          Fashion Art Toronto commands attention across North America&apos;s
          fastest-growing creative market. The platform delivers measurable
          reach to brands seeking authentic engagement with culture-shaping
          audiences.
        </p>
        ...
        <div className="flex flex-col gap-8 mt-8">
          <SectionHeading as="h3">Audience Profile Fall/Winter 2025</SectionHeading>

          <p className="reveal font-sans text-muted-foreground text-base md:text-lg leading-relaxed">
            FAT attracts a diverse community of fashion enthusiasts, industry
            professionals, and cultural curators passionate about bold,
            inclusive, and innovative fashion. The audience values creativity,
            sustainability, and the intersection of art and design.
          </p>
          ...
          <PullQuote
            quote="Bold creatives and tastemakers. Perfect for brands seeking to engage trendsetters and thought leaders."
          />
          ...
          <SectionHeading as="h3">Media Coverage & Press Partners</SectionHeading>

          <p className="reveal font-sans text-muted-foreground text-base md:text-lg leading-relaxed">
            FAT consistently generates strong earned media through editorial
            coverage across Vogue, Toronto Star, blogTO, Style Canada, Global
            News, and View the Vibe. The platform places brands inside the
            cultural narrative organically.
          </p>
